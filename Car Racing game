...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load("C:\\Users\\darsh\Downloads\\65-651151_cartoon-race-car-top-view.png")
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load("C:\\Users\\darsh\\Downloads\\17-172157_racing-car-cartoon-car-top-view.png")
        ...
        # Background
        self.bgImg = pygame.image.load("C:\\Users\\darsh\\Downloads\\vikas-sharma-city-track-8.jpg")
